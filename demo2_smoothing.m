...
for i = 1:length(imgRes(:,1))
   for j = 1:length(imgRes)
       imgFin(i,j) = round((0.1111*imFil(i,j))+(0.1111*imFil(i,j+1))+(0.1111*imFil(i,j+2))+(0.1111*imFil(i+1,j))+(0.1111*imFil(i+1,j+1))+(0.1111*imFil(i+1,j+2))+(0.1111*imFil(i+2,j))+(0.1111*imFil(i+2,j+1))+(0.1111*imFil(i+2,j+2)));
   end
end
